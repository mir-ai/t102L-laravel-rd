...
class MurakamiV01MessageController extends Controller
{
    /**
     * メッセージの一覧表示・検索画面
     *
    ...
    public function index(Request $request)
    {
        ...
        return view('murakami.v01.messages.index', [
            'messages' => $messages
        ]);
    }
    ...
    {
        // メッセージの登録画面を表示する
        return view('murakami.v01.messages.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        // 一覧表示ページにリダイレクトする
        return redirect()
            ->route('murakami.v01.messages.index')
