...
class KobayashiV01MessageController extends Controller
{
    /**
     * メッセージの一覧表示・検索画面
     *
    ...
    public function index(Request $request)
    {
        ...
        // resources/view/kobayashi/v01/logs/index.blade.php を読む
        return view('kobayashi.v01.messages.index', [
            'messages' => $messages
        ]);
    }
    ...
    {
        // メッセージの登録画面を表示する
        return view('kobayashi.v01.messages.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        // 一覧表示ページにリダイレクトする
        return redirect()
            ->route('kobayashi.v01.messages.index')
