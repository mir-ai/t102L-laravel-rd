    ...
    */
    ...
    'connections' => [
        ...
        'default' => [
            ...
            'host' => env('MQTT_HOST', 'af4m59y099o4d-ats.iot.ap-northeast-1.amazonaws.com'),
            ...
            'client_id' => env('MQTT_CLIENT_ID', 'LARAVEL_' . env('APP_NAME') . '_' . env('APP_ENV') . '_' . env('CITY_CODE')),
            ...
            'connection_settings' => [
                ...
                'tls' => [
                    ...
                    'ca_file' => env('MQTT_TLS_CA_FILE', storage_path('certs/awsiot_certs/250129/AmazonRootCA1.pem')),
                    'ca_path' => env('MQTT_TLS_CA_PATH', storage_path('certs/awsiot_certs/250129/')),
                    'client_certificate_file' => env('MQTT_TLS_CLIENT_CERT_FILE', storage_path('certs/awsiot_certs/250129/c3c5a040a8958d1c7ddc398e5c34b33929e86a4bab50b07a0b88c69a287768e2-certificate.pem.crt')),
                    'client_certificate_key_file' => env('MQTT_TLS_CLIENT_CERT_KEY_FILE', storage_path('certs/awsiot_certs/250129/c3c5a040a8958d1c7ddc398e5c34b33929e86a4bab50b07a0b88c69a287768e2-private.pem.key')),
